...
class LocoNetClass
{
        friend class LocoNetThrottleClass;
        friend class LocoNetFastClockClass;
        friend class LocoNetSystemVariableClass;

    private:
        LocoNetMessageBufferClass rxBuffer;
        LnTxStats txStats;
    ...
    public:
        ...
        uint8_t process();
        uint8_t process(uint8_t newByte);
...
class LocoNetThrottleClass
{
    private:
        ...
        LocoNetThrottleClass *myNext;		// LinkedList point to a list of all throttles attached to the LocoNetClass
    ...
    public:
        void init(LocoNetClass * lnInstance, uint8_t UserData, uint8_t Options, uint16_t ThrottleId);
...
class LocoNetFastClockClass
{
    ...
    public:
        void init(LocoNetClass * lnInstance, uint8_t DCS100CompatibleSpeed, uint8_t CorrectDCS100Clock,
...
class LocoNetSystemVariableClass
{
    ...
    public:
        void init(LocoNetClass *lnInstance, uint8_t newMfgId, uint8_t newDevId, uint16_t newProductId,
...
class LocoNetCVClass
{
    ...
    public:
        ...
        void init(LocoNetClass *lnInstance);
...
extern void notifyMessage(lnMsg *rxPacket) __attribute__ ((weak));
